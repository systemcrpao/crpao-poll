...
ว่าด้วยเรื่อง การเก็บภาษีบำรุงองค์การบริหารส่วนจังหวัด พ.ศ. 2555 แก้ไขเพิ่มเติม (ฉบับที่ 2) พ.ศ. 2569
            ...
            <div className="space-y-3 rounded-xl bg-blue-50/70 px-4 py-4 text-sm leading-relaxed text-gray-700">
              <p>
                ...
                โดยมีวัตถุประสงค์เพื่อรวบรวมความคิดเห็นของประชาชนชาวเชียงราย กับสถานการณ์ปัจจุบันที่เกิดภาวะสงครามในภูมิภาคตะวันออกกลางเป็นเหตุให้ราคาน้ำมันในตลาดโลกปรับตัวสูงขึ้นอย่างรวดเร็ว เพื่อเสนอต่อสภาองค์การบริหารส่วนจังหวัดเชียงราย ในการพิจารณาร่างประกาศฯ ดังกล่าวต่อไป
              </p>
